...
You are responsible for building and maintaining a production-grade app that adheres to a strict custom architecture defined in our http://ARCHITECTURE.md.
...
* Update http://ARCHITECTURE.md whenever structural or technological changes occur.
